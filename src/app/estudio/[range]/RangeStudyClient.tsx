              ...
              {!showResult ? (
                ...
                currentIndex < initialQuestions.length - 1 ? (
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white font-black py-6 rounded-2xl hover:bg-blue-700 flex items-center justify-center gap-2 transition-all shadow-xl shadow-blue-600/20"
                  >
                    Siguiente Pregunta
