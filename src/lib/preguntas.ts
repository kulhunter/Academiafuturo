...
export const bancoPreguntas: Question[] = [
    {
        "id": 1,
    ...
    },
    {
        ...
        "opciones": [
            ...
            "Para poder caminar sin problemas en el caso que necesite solicitar ayuda."
        ],
        "type": "single",
        "correcta": 0
    },
    ...
    {
        "id": 7,
        "pregunta": "¿Qué significa esta luz de advertencia en el panel de instrumentos?",
        "opciones": [
            "Luces neblineras.",
    ...
    {
        "id": 10,
        "pregunta": "¿Cuál de estos líquidos, en el caso de estar en un nivel bajo, podría causar un accidente?",
        "opciones": [
            "El líquido de freno.",
            "El anticongelante.",
    ...
    {
        "id": 12,
        "pregunta": "¿Cuándo usaría usted las luces intermitentes de advertencia de peligro?",
        "opciones": [
    ...
    {
        "id": 13,
        "pregunta": "Las luces de advertencia de peligro deberían ser usadas:",
        "opciones": [
    ...
    {
        "id": 14,
        "pregunta": "¿Cuándo usaría usted las luces de advertencia de peligro de su vehículo?",
        "opciones": [
    ...
    {
        "id": 15,
        "pregunta": "Usted está probando la suspensión de su vehículo cuando nota que éste rebota u oscila al cargarlo en un extremo lateral frontal.\n¿Qué significa esto?",
        "opciones": [
            "Neumáticos gastados.",
    ...
    {
        "id": 17,
        "pregunta": "¿A qué se debe un alto consumo de combustible?",
        "opciones": [
    ...
    {
        "id": 18,
        "pregunta": "La profundidad de los surcos de los neumáticos de un automóvil no debería ser inferior a ...",
        "opciones": [
            "5.0 mm",
            "4.0 mm",
            "1.6 mm",
    ...
    {
        "id": 19,
        "pregunta": "Uno de sus neumáticos traseros se revienta mientras usted conduce. ¿Cuáles 2 cosas debe hacer usted?",
        "opciones": [
    ...
    {
        "id": 20,
        "pregunta": "¿Cuáles 2 cosas debe usted hacer si se le revienta un neumático delantero?",
        "opciones": [
    ...
    {
        "id": 22,
        "pregunta": "Desenganchar el motor del vehículo...",
        "opciones": [
    ...
    {
        "id": 23,
        "pregunta": "¿Por qué no es bueno desenganchar el motor del vehículo al ir circulando?",
        "opciones": [
    ...
    {
        "id": 24,
        "pregunta": "¿Cuáles son las 2 principales razones por las cuales no debe desengancharse el motor al ir cuesta abajo?",
        "opciones": [
    ...
    {
        "id": 25,
        "pregunta": "¿Por qué usted no debería conducir presionando el pedal de embrague durante más tiempo que el necesario?",
        "opciones": [
    ...
    {
        "id": 27,
        "pregunta": "Una baja presión de aire en los neumáticos delanteros ...",
        "opciones": [
    ...
    {
        "id": 28,
        "pregunta": "En un pavimento mojado, ¿influye el estado de los neumáticos en la distancia de frenado de su vehículo?",
        "opciones": [
    ...
    {
        "id": 30,
        "pregunta": "¿Cuáles 2 de las siguientes afirmaciones son verdaderas?",
        "opciones": [
    ...
    {
        "id": 35,
        "pregunta": "¿Qué elementos de su vehículo debe usted mantener limpios?",
        "opciones": [
            "Las luces.",
            "Los espejos.",
            "Los neumáticos.",
    ...
    {
        "id": 37,
        "pregunta": "¿Cuál de las siguientes afirmaciones es falsa cuando usted aumenta su velocidad de 30 km/h a 60 km/h?",
        "opciones": [
    ...
    {
        "id": 38,
        "pregunta": "El auto azul circula a 70 km/h y el rojo a 90 km/h. ¿Dónde es más probable que sus conductores estimen el punto en que se producirá el encuentro de ambos vehículos?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/38.png"
    },
    {
        "id": 39,
        "pregunta": "¿Qué distancia de detención tiene un tren que circula a alrededor de 100 km/h?",
        "opciones": [
    ...
    {
        "id": 41,
        "pregunta": "Usted va circulando a 50 km/h a lo largo de un camino plano y de asfalto. Las condiciones climáticas son buenas. Sus neumáticos y frenos también están buenos. En estas circunstancias, detenerse le tomará aproximadamente ...",
        "opciones": [
            "unos 50 metros",
            "unos 15 metros",
            "unos 10 metros",
    ...
    {
        "id": 42,
        "pregunta": "La distancia de detención total es igual a la suma de la distancia de reacción y la de frenado. Aproximadamente, ¿cuál es la mínima distancia de detención total en un asfalto seco, si usted viaja a 90 km/h?",
        "opciones": [
            "Unos 50 metros",
            "Unos 70 metros",
            "Unos 30 metros",
    ...
    {
        "id": 43,
        "pregunta": "Usted conduce un vehículo con frenos y neumáticos en buenas condiciones. La superficie de calzada está seca. ¿Cuál es la distancia aproximada de detención total (distancia de reacción más distancia de frenado) si usted va a 70 km/h?",
        "opciones": [
            "Unos 15 metros",
            "Unos 80 metros",
            "Unos 45 metros",
    ...
    {
        "id": 44,
        "pregunta": "Usted desea estacionar en bajada en una calle con pendiente pronunciada. ¿Qué debería hacer?",
        "opciones": [
    ...
    {
        "id": 45,
        "pregunta": "Usted está descendiendo una pendiente muy larga. ¿Qué debería hacer para ayudar a controlar la velocidad de su vehículo?",
        "opciones": [
    ...
    {
        "id": 46,
        "pregunta": "Usted está virando hacia la derecha en un camino resbaladizo y las ruedas traseras de su vehículo resbalan hacia la izquierda.\n¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 47,
        "pregunta": "Usted está próximo a descender por una pendiente muy pronunciada. ¿Qué debería hacer para controlar la velocidad de su vehículo?",
        "opciones": [
    ...
    {
        "id": 48,
        "pregunta": "La distancia de frenado es la que recorre un vehículo desde que se presiona el freno hasta que el vehículo se detiene. En condiciones normales, ¿cuál sería aproximadamente su distancia de frenado si usted circula a 90 km/h?",
        "opciones": [
            "Unos 45 metros",
            "Unos 70 metros",
            "Unos 20 metros",
    ...
    {
        "id": 49,
        "pregunta": "¿Qué debería hacer usted si está tomando un remedio para la tos y no está seguro si éste puede afectar su conducción?",
        "opciones": [
    ...
    {
        "id": 75,
        "pregunta": "Usted está tomando unos remedios que probablemente afectarán su conducción. ¿Qué debería hacer?",
        "opciones": [
    ...
    {
        "id": 76,
        "pregunta": "Su doctor le ha recetado un tratamiento. ¿Por qué usted debe consultarle si puede conducir o no?",
        "opciones": [
    ...
    {
        "id": 77,
        "pregunta": "Si usted ha ingerido alcohol, ¿cuál o cuáles son los efectos más probables?",
        "opciones": [
    ...
    {
        "id": 78,
        "pregunta": "¿Cómo afecta el consumo de alcohol a su conducción?",
        "opciones": [
    ...
    {
        "id": 79,
        "pregunta": "Si usted va conduciendo y comienza a sentir cansancio, es mejor que se detenga lo antes posible. ¿Qué debería hacer usted mientras no pueda detenerse?",
        "opciones": [
    ...
    {
        "id": 81,
        "pregunta": "Un conductor hace algo que a usted le molesta. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 82,
        "pregunta": "Usted está a punto de volver a casa conduciendo, pero no puede encontrar los anteojos que necesita usar para conducir. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 85,
        "pregunta": "Usted comienza a sentir cansancio en un viaje. ¿Qué debería hacer?",
        "opciones": [
    ...
    {
        "id": 86,
        "pregunta": "¿Qué precauciones debe tomar un conductor cuando asiste a un evento social?",
        "opciones": [
    ...
    {
        "id": 87,
        "pregunta": "De los siguientes efectos, ¿cuál no es consecuencia del consumo de alcohol antes de conducir?",
        "opciones": [
    ...
    {
        "id": 88,
        "pregunta": "De las siguientes capacidades de un individuo, ¿cuál de ellas no se ve afectada por el consumo de alcohol?",
        "opciones": [
    ...
    {
        "id": 90,
        "pregunta": "¿Cuándo es más probable que usted pierda concentración cuando conduce?",
        "opciones": [
    ...
    {
        "id": 91,
        "pregunta": "¿Qué debería hacer el conductor del auto señalado con la flecha?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/91.png"
    },
    {
        "id": 92,
        "pregunta": "¿Cuáles son las 2 principales razones por las que no sería adecuado que usted adelantara al peatón en este momento?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/92.png"
    },
    {
        "id": 93,
        "pregunta": "En relación con los cruces ferroviarios a nivel, ¿cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)?",
        "opciones": [
    ...
    {
        "id": 94,
        "pregunta": "En esta ocasión usted va conduciendo a 70 km/h. ¿Qué hace usted?",
        "opciones": [
            "Frena en seco.",
        ...
        "imagen": "/img/preguntas/94.png"
    },
    {
        "id": 95,
        "pregunta": "Al aproximarse a una curva hacia la izquierda usted debería mantenerse bien a la derecha. ¿Por qué?",
        "opciones": [
    ...
    {
        "id": 96,
        "pregunta": "Usted conduce por una vía rápida en muy buenas condiciones. Por seguridad, ¿qué distancia debería mantener usted respecto del vehículo que va adelante suyo?",
        "opciones": [
    ...
    {
        "id": 97,
        "pregunta": "Usted se aproxima a una curva hacia la izquierda. ¿Qué debería hacer?",
        "opciones": [
    ...
    {
        "id": 99,
        "pregunta": "Mire el dibujo. ¿Cuál es el peligro al que usted debe estar más atento(a)?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 0,
        "imagen": "/img/preguntas/99.png"
    },
    {
        "id": 100,
        "pregunta": "Usted pretende doblar hacia la izquierda en un cruce, pero hay vehículos estacionados que le obstruyen la visual. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 101,
        "pregunta": "Usted va conduciendo al lado de una fila de autos estacionados. De pronto ve una pelota rebotando en la calzada un poco más adelante. ¿Qué debería hacer usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/101.png"
    },
    {
        "id": 102,
        "pregunta": "Al adelantar a animales que van por el camino, usted no debería...",
        "opciones": [
    ...
    {
        "id": 103,
        "pregunta": "Al adelantar en un camino a una manada de ovejas, ¿qué hace usted?",
        "opciones": [
    ...
    {
        "id": 104,
        "pregunta": "Usted va conduciendo por una calle de dos pistas y de doble sentido de tránsito en la cual hay vehículos estacionados al costado derecho. ¿Por cuáles 3 razones usted debe disminuir su velocidad?",
        "opciones": [
    ...
    {
        "id": 105,
        "pregunta": "Usted está esperando en un cruce en T. El vehículo azul que se acerca desde la izquierda señaliza a la derecha. ¿Qué debería hacer usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/105.png"
    },
    {
        "id": 106,
        "pregunta": "Usted se ha quedado detenido justo al medio de un cruce ferroviario con sistema automático de señales y barreras y no puede echar a andar el motor nuevamente. La campanilla del cruce comienza a sonar. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 107,
        "pregunta": "¿A qué debe estar especialmente atento el conductor del vehículo indicado con la flecha?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/107.png"
    },
    {
        "id": 108,
        "pregunta": "¿Qué debería hacer el conductor del auto indicado con la flecha?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/108.png"
    },
    {
        "id": 109,
        "pregunta": "¿Qué debería hacer el conductor del auto señalado con la flecha?",
        "opciones": [
            "Retrocer para salir del cruce.",
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/109.png"
    },
    {
        "id": 110,
        "pregunta": "¿Cuál es el principal peligro cuando usted sobrepasa al bus que está detenido en la parada?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/110.png"
    },
    {
        "id": 111,
        "pregunta": "¿Qué significa la señal que está efectuando el camión?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/111.png"
    },
    {
        "id": 112,
        "pregunta": "¿Qué debe hacer usted cuando va en una fila de autos?",
        "opciones": [
    ...
    {
        "id": 113,
        "pregunta": "¿Hacia dónde es más importante que usted mire en este momento?",
        "opciones": [
            "A",
            "B",
            "C",
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/113.png"
    },
    {
        "id": 114,
        "pregunta": "En esta situación, ¿a cuáles 3 riesgos debe estar usted principalmente atento?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/114.png"
    },
    {
        "id": 115,
        "pregunta": "Usted va conduciendo a 70 km/h que es la velocidad máxima permitida en esta vía. ¿Qué hace en esta situación?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/115.png"
    },
    {
        "id": 116,
        "pregunta": "¿Qué hace usted ante esta situación?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/116.png"
    },
    {
        "id": 117,
        "pregunta": "Mientras va conduciendo su vehículo usted siente que lo están llamando a su teléfono celular, ¿qué hace usted para responder la llamada?",
        "opciones": [
            "Reduce su velocidad.",
    ...
    {
        "id": 118,
        "pregunta": "Usted debería utilizar su teléfono celular en su automóvil sólo en la siguiente situación:",
        "opciones": [
    ...
    {
        "id": 119,
        "pregunta": "En un camino muy transitado usted desea adelantar a un camión con remolque que va lentamente delante suyo, ¿qué debería hacer usted?",
        "opciones": [
            ...
            "Encender y apagar sus luces para que quienes vienen en contra le faciliten el adelantamiento.",
    ...
    {
        "id": 120,
        "pregunta": "La mayor parte de los accidentes de tránsito se produce en:",
        "opciones": [
            "Carreteras",
            "Salidas de colegios",
            "Caminos rurales",
    ...
    {
        "id": 121,
        "pregunta": "Entre los accidentes de tránsito se distinguen distintos tipos de éstos. En Chile, ¿cuál es el tipo de accidente que origina la mayor cantidad de muertos?",
        "opciones": [
    ...
    {
        "id": 122,
        "pregunta": "Al estar estacionado, ¿qué debería hacer usted justo antes de poner su vehículo en movimiento?",
        "opciones": [
            "Ajustar sus espejos.",
    ...
    {
        "id": 123,
        "pregunta": "Las fotografías muestran una secuencia cronológica de imágenes. ¿Cuáles son las 2 principales causas por las que surge esta situación de peligro?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/123.png"
    },
    {
        "id": 124,
        "pregunta": "Usted llega a una intersección regulada por semáforo que se encuentra en rojo y, al mismo tiempo, un Carabinero le indica que avance, ¿qué debe hacer usted?",
        "opciones": [
    ...
    {
        "id": 125,
        "pregunta": "¿En qué situación puede usted hacer uso de la bocina de su vehículo?",
        "opciones": [
    ...
    {
        "id": 126,
        "pregunta": "¿Cuándo puede usted hacer sonar la bocina de su auto?",
        "opciones": [
    ...
    {
        "id": 127,
        "pregunta": "Usted se va acercando a un cruce semaforizado. ¿Cuándo no debe usted ingresar al cruce aunque el semáforo esté en verde?",
        "opciones": [
    ...
    {
        "id": 128,
        "pregunta": "Fuera de la ciudad, usted va por una carretera de doble calzada con dos pistas por sentido. La velocidad máxima permitida es de 100 km/hr. Si usted va a 90 km/hr y no van vehículos delante suyo, ¿por cuál pista circula usted?",
        "opciones": [
    ...
    {
        "id": 129,
        "pregunta": "En una carretera de doble calzada con dos pistas por sentido, ¿en cuáles 2 de las siguientes situaciones usted usaría la pista izquierda?",
        "opciones": [
    ...
    {
        "id": 130,
        "pregunta": "Usted se aproxima a un cruce cebra. En la vereda hay peatones esperando cruzar. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 131,
        "pregunta": "Usted se aproxima a un cruce de calles no señalizado. Por la otra calle también se aproxima un vehículo que pretende pasar el cruce. ¿Quién tiene la prioridad para pasar?",
        "opciones": [
    ...
    {
        "id": 132,
        "pregunta": "Cuando dos vehículos van a cruzarse en una intersección en la que no hay señalización alguna, ¿quién debe ceder el paso?",
        "opciones": [
    ...
    {
        "id": 133,
        "pregunta": "¿Es seguro permitir que los niños viajen en un vehículo de 3 o 5 puertas en el espacio que queda detrás de los asientos traseros?",
        "opciones": [
    ...
    {
        "id": 134,
        "pregunta": "¿Cuáles son las 2 formas más seguras para transportar una guagua en su automóvil?",
        "opciones": [
    ...
    {
        "id": 135,
        "pregunta": "¿Cuál es la forma más segura para llevar a un niño de 3 ó 4 años en su vehículo?",
        "opciones": [
    ...
    {
        "id": 137,
        "pregunta": "En un vehículo de 3 o 5 puertas, ¿en qué condiciones sería seguro transportar niños pequeños en el espacio que queda detrás de los asientos traseros?",
        "opciones": [
    ...
    {
        "id": 138,
        "pregunta": "Usted está en una calle de un solo sentido de tránsito y desea virar a la izquierda. ¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s)?",
        "opciones": [
    ...
    {
        "id": 142,
        "pregunta": "Usted va detrás de un camión articulado que va a doblar a la derecha hacia una vía angosta. ¿Qué debe hacer usted?",
        "opciones": [
    ...
    {
        "id": 145,
        "pregunta": "Usted ha alcanzado a un auto al que desea adelantar. ¿Cuáles son las 3 cosas más difíciles de juzgar?",
        "opciones": [
            ...
            "La distancia al vehículo que viene en sentido contrario.",
    ...
    {
        "id": 146,
        "pregunta": "Usted va conduciendo su vehículo a 90 km/h que es la velocidad máxima permitida en esa vía. ¿Qué hace usted si a pesar de todo un vehículo desea adelantarlo?",
        "opciones": [
        ...
        "imagen": "/img/preguntas/146.png"
    },
    {
        "id": 147,
        "pregunta": "Usted va por una carretera a 100 km/h. ¿Qué hace usted si a pesar de todo un vehículo que viene atrás desea adelantarlo?",
        "opciones": [
    ...
    {
        "id": 148,
        "pregunta": "Usted desea adelantar. ¿Cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)?",
        "opciones": [
        ...
        "type": "multiple",
        "correcta": 3,
        "imagen": "/img/preguntas/148.png"
    },
    {
        "id": 149,
        "pregunta": "Usted ha comenzado a adelantar. El auto de la derecha va a aproximadamente 80 km/h. Por su espejo retrovisor usted ve otro auto que tiene intención de adelantar. ¿Qué hace usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 0,
        "imagen": "/img/preguntas/149.png"
    },
    {
        "id": 150,
        "pregunta": "Antes de adelantar a un vehículo de gran tamaño usted debería mantenerse suficientemente atrás de él. ¿Por qué?",
        "opciones": [
    ...
    {
        "id": 151,
        "pregunta": "¿Por qué adelantar a un camión es más arriesgado que adelantar a un auto?",
        "opciones": [
    ...
    {
        "id": 152,
        "pregunta": "Usted está a punto de adelantar a un vehículo pesado. ¿Qué debería hacer?",
        "opciones": [
            "Tocar la bocina para advertle al conductor que usted está ahí.",
    ...
    {
        "id": 153,
        "pregunta": "Usted va conduciendo de día por una zona rural. La calzada tiene pavimento en buen estado y tránsito bidireccional. A menos que alguna señal le indique otra cosa, usted no debe exceder los ...",
        "opciones": [
            "50 km/hr",
            "90 km/hr",
            "120 km/hr",
    ...
    {
        "id": 154,
        "pregunta": "Usted va conduciendo en la ciudad por una calle con 2 pistas en sentido único de tránsito. A menos que alguna señal le indique otra cosa, usted no debe exceder los ...",
        "opciones": [
            "30 km/hr",
            "60 km/hr",
            "50 km/hr",
    ...
    {
        "id": 155,
        "pregunta": "Como norma general, antes de tomar una curva cerrada, usted debe ...",
        "opciones": [
    ...
    {
        "id": 158,
        "pregunta": "Por una emergencia usted requiere estacionar de noche en una carretera sin alumbrado y con buenas bermas. ¿Cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)?",
        "opciones": [
    ...
    {
        "id": 160,
        "pregunta": "¿En qué circunstancia usted se detendría justo sobre un cruce cebra existente a mitad de cuadra?",
        "opciones": [
            "En ningún momento.",
    ...
    {
        "id": 161,
        "pregunta": "Como regla general, ¿en cuál o cuáles de los siguientes lugares usted no debe estacionar?",
        "opciones": [
    ...
    {
        "id": 162,
        "pregunta": "¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s) tratándose de una vía urbana sin señales de tránsito que prohiban o autoricen el estacionamiento o la detención?",
        "opciones": [
    ...
    {
        "id": 163,
        "pregunta": "Usted va a dejar su vehículo estacionado. ¿En qué caso puede dejarlo con el motor funcionando?",
        "opciones": [
            "En ningún caso.",
    ...
    {
        "id": 164,
        "pregunta": "En una vía urbana de sentido único de tránsito, sin señalización que permita o prohíba el estacionamiento, ¿a qué lado puede estacionar?",
        "opciones": [
            "A ambos lados.",
    ...
    {
        "id": 165,
        "pregunta": "¿En cuáles 3 de las siguientes ocasiones debe usted detener siempre su vehículo?",
        "opciones": [
    ...
    {
        "id": 166,
        "pregunta": "¿A cuántos metros de una esquina es lo más cerca que usted puede estacionar?",
        "opciones": [
            "5 metros",
            "10 metros",
            "12 metros",
        ...
        "type": "single",
        "correcta": 1,
        "imagen": "/img/preguntas/166.png"
    },
    {
        "id": 167,
        "pregunta": "Como regla general, ¿en cuál o cuáles de los siguientes lugares nunca debe estacionar?",
        "opciones": [
            "En un paso de peatones.",
            "En un puente.",
    ...
    {
        "id": 168,
        "pregunta": "De noche, en una zona rural, por emergencia usted estaciona su vehículo al costado de la vía. ¿En qué circunstancia debe usted encender sus luces de estacionamiento?",
        "opciones": [
    ...
    },
    {
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/169.png"
    },
    {
        "id": 170,
        "pregunta": "Usted conduce a 90 km/h cuando la vía es obstruida sorpresivamente por un camión que está virando a la izquierda. ¿Qué es lo primero que hace usted ?",
        "opciones": [
            "Hace señales de luces e toca la bocina.",
            "Frena firmemente.",
        ...
        "type": "single",
        "correcta": 1,
        "imagen": "/img/preguntas/170.png"
    },
    {
        "id": 171,
        "pregunta": "¿Adquiere usted un derecho sobre otros usuarios de la vía cuando utiliza sus luces indicadoras de viraje?",
        "opciones": [
    ...
    {
        "id": 173,
        "pregunta": "Usted conduce un vehículo de marcha lenta por un camino angosto y sinuoso. En estas circunstancias, usted debería ...",
        "opciones": [
    ...
    {
        "id": 175,
        "pregunta": "El conductor detrás suyo le sigue muy de cerca. ¿Qué hace usted?",
        "opciones": [
            "Señalizar a la derecha y le indica con lo mano para que lo adelante.",
    ...
    {
        "id": 176,
        "pregunta": "Un bus está detenido en una parada delante suyo. El intermitente izquierdo del bus está parpadeando. ¿Qué hace usted?",
        "opciones": [
            "Hace parpadear sus luces delanteras y disminuye la velocidad.",
            "Toca la bocina y continúa.",
            "Disminuye la velocidad y luego toca la bocina.",
            "Disminuye la velocidad y cede el paso al bus, siempre que ello sea seguro."
        ],
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/176.png"
    },
    {
        "id": 177,
        "pregunta": "Usted va conduciendo en una carretera a la velocidad máxima permitida. El conductor que viene detrás suyo está tratando de adelantarlo. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 178,
        "pregunta": "Usted se está aproximando a un cruce cuando sorpresivamente un vehículo ingresa a la vía por la que usted va y se ubica delante suyo. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 179,
        "pregunta": "Usted va conduciendo a la velocidad máxima permitida. Un vehículo se acerca muy rápido por atrás encendiendo y apagando sus luces. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 180,
        "pregunta": "Un espacio entre usted y el vehículo que marcha delante igual a lo que usted recorre en tres segundos es suficiente cuando ...",
        "opciones": [
    ...
    {
        "id": 181,
        "pregunta": "Usted está conduciendo al límite de la velocidad máxima permitida y un conductor intenta adelantarlo. ¿Trataría usted de evitar que lo adelante?",
        "opciones": [
    ...
    {
        "id": 182,
        "pregunta": "De los siguientes factores, ¿cuál es el que con mayor frecuencia se presenta en las colisiones por la parte trasera?",
        "opciones": [
    ...
    {
        "id": 184,
        "pregunta": "¿Cuál de los siguientes grupos de conductores tiene mayores probabilidades de verse involucrado en un accidente de tránsito?",
        "opciones": [
    ...
    {
        "id": 185,
        "pregunta": "En una zona rural, usted va conduciendo por un camino muy angosto. ¿Dónde le resultaría más difícil ver personas a caballo que avanzan delante suyo?",
        "opciones": [
    ...
    {
        "id": 186,
        "pregunta": "Usted va detrás de un camión articulado que se aproxima a un cruce. Su conductor señaliza hacia la derecha pero el vehículo se desplaza hacia la izquierda. ¿Qué debe hacer usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 1,
        "imagen": "/img/preguntas/186.png"
    },
    {
        "id": 187,
        "pregunta": "En una carretera de doble calzada con 2 pistas por sentido de tránsito, usted desea pasar al vehículo que va delante suyo. Por su espejo retrovisor ve que el auto que viene atrás se está cambiando de pista para sobrepasarlo a usted. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 188,
        "pregunta": "Un vehículo emerge sorpresivamente desde una vía lateral situándose delante suyo y obligándolo a frenar fuertemente. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 189,
        "pregunta": "Usted se detiene ante un cruce cebra. En la vereda hay peatones esperando, pero ellos no comienzan a cruzar. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 190,
        "pregunta": "Cuando el viento sopla muy fuertemente usted necesita tener especial cuidado ...",
        "opciones": [
            "al usar los frenos.",
    ...
    {
        "id": 191,
        "pregunta": "En un cruce hay peatones atravesando la calle hacia la cual usted está virando. ¿Qué debe hacer usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/191.png"
    },
    {
        "id": 192,
        "pregunta": "En un cruce hay peatones atravesando la calle hacia la cual usted está virando. ¿Qué hace usted?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 0,
        "imagen": "/img/preguntas/192.png"
    },
    {
        "id": 193,
        "pregunta": "¿Dónde debe tener usted especial cuidado con los motociclistas?",
        "opciones": [
    ...
    {
        "id": 194,
        "pregunta": "Cuando conduce en la ciudad ¿por qué razón debería usted tener cuidado al cruzarse con un bus que se encuentra detenido en una parada?",
        "opciones": [
            "Porque el bus puede estar en pana.",
            "Porque el bus puede poner se en movimiento repentinamente.",
    ...
    {
        "id": 195,
        "pregunta": "Usted se encuentra muy próximo a un cruce en el que pretende virar a la derecha. Delante suyo va un ciclista. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 198,
        "pregunta": "Usted va circulando a 65 km/h aproximadamente cuando, lamentablemente, atropella a un peatón. A esa velocidad, ....",
        "opciones": [
    ...
    {
        "id": 200,
        "pregunta": "Usted va siguiendo a un automóvil que es conducido por una persona de edad. Usted debería ...",
        "opciones": [
    ...
    {
        "id": 201,
        "pregunta": "Al estacionar su vehículo en un lugar en el que no hay señales que lo permitan ni que lo prohiban, usted no debe ....",
        "opciones": [
    ...
    {
        "id": 202,
        "pregunta": "Usted nunca debería intentar adelantar a un ciclista ...",
        "opciones": [
    ...
    {
        "id": 203,
        "pregunta": "Cuando adelanta a un ciclista usted debe dejar el máximo espacio lateral posible. ¿Por qué?",
        "opciones": [
    ...
    {
        "id": 204,
        "pregunta": "Cuando el viento está soplando muy fuerte, ¿por qué debe usted dejar un espacio lateral extra al adelantar a un motociclista?",
        "opciones": [
    ...
    {
        "id": 205,
        "pregunta": "¿De qué le advierte esta señal?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 0,
        "imagen": "/img/preguntas/205.png"
    },
    {
        "id": 206,
        "pregunta": "Cuando es de noche, al adelantar usted debería ...",
        "opciones": [
    ...
    {
        "id": 207,
        "pregunta": "Por una carretera, usted circula detrás de otro vehículo. Si la calzada está mojada, ¿qué espacio de tiempo mínimo mantiene usted respecto del vehículo que va adelante?",
        "opciones": [
    ...
    {
        "id": 208,
        "pregunta": "Usted está conduciendo de noche y es encandilado por las luces delanteras de un vehículo que se aproxima. En estas circunstancias, ¿qué hace usted?",
        "opciones": [
    ...
    {
        "id": 209,
        "pregunta": "¿Cuál o cuáles de las siguientes afirmaciones son correctas en cuanto a la conducción durante la noche?",
        "opciones": [
    ...
    {
        "id": 210,
        "pregunta": "¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s) en cuanto a la conducción nocturna en un camino rural?",
        "opciones": [
    ...
    {
        "id": 211,
        "pregunta": "¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s) en cuanto a la conducción bajo la lluvia?",
        "opciones": [
    ...
    {
        "id": 212,
        "pregunta": "¿Cuáles son las 2 causas más comunes de los resbalones ante la existencia de agua en la calzada?",
        "opciones": [
    ...
    {
        "id": 213,
        "pregunta": "Viajando de noche usted es encandilado por las luces de un vehículo que viene en sentido contrario, ¿qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 214,
        "pregunta": "Conduciendo de noche usted se ve encandilado por las luces de un vehículo que viene en sentido contrario, ¿qué debería hacer usted?",
        "opciones": [
            "Frenar fuerte.",
    ...
    {
        "id": 215,
        "pregunta": "Al frenar en una calzada mojada su vehículo comienza a patinar. ¿Qué es lo primero que usted debería hacer?",
        "opciones": [
    ...
    {
        "id": 216,
        "pregunta": "¿Cómo puede usted evitar que los neumáticos patinen cuando la calzada está con hielo?",
        "opciones": [
    ...
    {
        "id": 217,
        "pregunta": "Cuando la calzada está con hielo la distancia de frenado puede ser ...",
        "opciones": [
    ...
    {
        "id": 218,
        "pregunta": "Al conducir con neblina a la luz del día, ¿qué luces enciende usted ?",
        "opciones": [
    ...
    {
        "id": 219,
        "pregunta": "Al conducir sobre una calzada con hielo usted siente la dirección de su vehículo más liviana. ¿ Por qué sucede esto?",
        "opciones": [
    ...
    {
        "id": 220,
        "pregunta": "¿Cuándo es su distancia de detención total mucho más larga?",
        "opciones": [
            "Cuando hay neblina.",
            "Cuando es de noche.",
    ...
    {
        "id": 221,
        "pregunta": "Usted acaba de conducir a través de una calle inundada. ¿Qué es lo primero que debería hacer?",
        "opciones": [
            "Chequear sus frenos.",
    ...
    {
        "id": 222,
        "pregunta": "¿Cómo puede usted evitar que su vehículo patine cuando la calzada está cubierta con una capa de hielo?",
        "opciones": [
    ...
    {
        "id": 223,
        "pregunta": "Usted está conduciendo bajo mucha lluvia y repentinamente siente la dirección muy liviana. ¿Qué hace usted para tener nuevamente el control de su vehículo?",
        "opciones": [
    ...
    {
        "id": 224,
        "pregunta": "Cuando hay nieve lo mejor es conducir manteniéndose en la marcha más alta posible. ¿Por qué es esto?",
        "opciones": [
    ...
    {
        "id": 225,
        "pregunta": "¿Cuál es la principal razón por la cual su distancia de detención total es mayor después de una lluvia torrencial?",
        "opciones": [
    ...
    {
        "id": 227,
        "pregunta": "En un pavimento mojado usted va circulando detrás de un vehículo manteniéndose a una distancia segura de él. De pronto es adelantado por otro vehículo que se ubica en el espacio que usted había dejado. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 229,
        "pregunta": "Al ir de noche por una carretera usted debe mantener sus focos delanteros encendidos, a menos que ...",
        "opciones": [
    ...
    {
        "id": 232,
        "pregunta": "Usted va conduciendo de noche por una carretera cerca de otros vehículos que van delante suyo. ¿Qué luces debería mantener encendidas?",
        "opciones": [
    ...
    {
        "id": 233,
        "pregunta": "¿Por qué razón debería usted reducir siempre su velocidad al conducir con neblina?",
        "opciones": [
    ...
    {
        "id": 234,
        "pregunta": "Su vehículo ha quedado en pana en medio de una autopista. ¿Qué es lo primero que usted debería hacer?",
        "opciones": [
    ...
    },
    {
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/235.png"
    },
    {
        "id": 236,
        "pregunta": "En una calle de una pista por sentido de tránsito usted se encuentra con que su pista está obstruida. ¿Qué hace usted?",
        "opciones": [
    ...
    {
        "id": 238,
        "pregunta": "En relación con el transporte de una carga sobre la parrilla de un automóvil, ¿cuál de las siguientes afirmaciones constituye una obligación para el conductor?",
        "opciones": [
    ...
    {
        "id": 239,
        "pregunta": "¿Cómo puede usted detener el zigzagueo de una casa rodante que va remolcando?",
        "opciones": [
    ...
    {
        "id": 240,
        "pregunta": "¿Qué precaución debe tomar usted al cargar un remolque que va a arrastrar con su automóvil?",
        "opciones": [
    ...
    {
        "id": 242,
        "pregunta": "Combine los números de las señales con los textos que correspondan.",
        "opciones": [
            "Mantenga su derecha",
    ...
    {
        "id": 244,
        "pregunta": "Al ir circulando en su vehículo usted enfrenta esta señal. ¿Qué significa?",
        "opciones": [
    ...
    },
    {
        ...
        "type": "single",
        "correcta": 0,
        "imagen": "/img/preguntas/245.png"
    },
    {
        "id": 246,
        "pregunta": "¿Cuándo puede usted ingresar a un cruce en cuya calzada se han pintado franjas amarillas diagonales?",
        "opciones": [
    ...
    {
        "id": 253,
        "pregunta": "¿Para qué sirven las señales amarillas con forma de rombo?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 3,
        "imagen": "/img/preguntas/253.png"
    },
    {
        "id": 254,
        "pregunta": "¿Qué significa un semáforo en amarillo?",
        "opciones": [
    ...
    {
        "id": 260,
        "pregunta": "De las siguientes señales de tránsito, ¿cuál o cuáles corresponden a señales amarillas con forma de rombo?",
        "opciones": [
            "Puente angosto",
            "Angostamiento de la vía",
            "Dirección obligada",
    ...
    {
        "id": 262,
        "pregunta": "¿Qué significa la demarcación de centro de calzada que muestra la figura?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 1,
        "imagen": "/img/preguntas/262.png"
    },
    {
        "id": 263,
        "pregunta": "El vehículo indicado con la flecha se encuentra detenido sobre una zona achurada esperando poder efectuar un viraje en U, ¿es esto correcto?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/263.png"
    },
    {
        "id": 264,
        "pregunta": "De acuerdo a las circunstancias que se aprecian en la fotografía, ¿sería correcto que el automóvil indicado con la flecha continuara derecho ?",
        "opciones": [
            "Sí",
            "No"
        ],
        "type": "single",
        "correcta": 1,
        "imagen": "/img/preguntas/264.png"
    },
    {
        "id": 265,
        "pregunta": "¿Qué le indica la señal de tránsito que se observa en la fotografía?",
        "opciones": [
        ...
        "type": "single",
        "correcta": 2,
        "imagen": "/img/preguntas/265.png"
    },
    {
        "id": 266,
        "pregunta": "¿Qué significa la luz verde del semáforo?",
        "opciones": [
    ...
    {
        "id": 267,
        "pregunta": "¿Cuándo no debería usted detenerse al ponerse el semáforo en amarillo?",
        "opciones": [
    ...
    {
        "id": 269,
        "pregunta": "Excepcionalmente, un joven de 17 años puede obtener licencia de conducir clase B. En tanto no cumpla 18 años deberá conducir siempre acompañado. ¿Qué requisitos debe cumplir su acompañante?",
        "opciones": [
    ...
    {
        "id": 270,
        "pregunta": "Usted se ve involucrado en un accidente. Un pasajero del otro vehículo ha resultado con lesiones leves. ¿Debe usted informar el hecho a la policía?",
        "opciones": [
    ...
    {
        "id": 271,
        "pregunta": "Usted se ha detenido en el lugar de un accidente para prestar ayuda. ¿Qué debería hacer usted ?",
        "opciones": [
    ...
    {
        "id": 272,
        "pregunta": "Usted es el primero en llegar al sitio de un accidente. ¿Qué debería hacer usted?",
        "opciones": [
    ...
    {
        "id": 273,
        "pregunta": "Usted es el primero en llegar al lugar de un accidente en el que hay heridos graves. ¿Qué hace usted?",
        "opciones": [
            "Enciende sus luces de advertencia de peligro.",
    ...
    {
        "id": 274,
        "pregunta": "Usted llega al lugar de un accidente en el que participó un camión cargado con productos químicos peligrosos. ¿Qué debería hacer usted antes de llamar al 133 de Carabineros?",
        "opciones": [
    ...
    {
        "id": 275,
        "pregunta": "Usted llega al lugar de un accidente en el que ha participado un motociclista. El motociclista yace consciente, pero en estado de shock. ¿De qué debería asegurarse usted?",
        "opciones": [
    ...
    {
        "id": 277,
        "pregunta": "¿Quién o quiénes están cubiertos por el Seguro Obligatorio de Accidentes Personales?",
        "opciones": [
    ...
    {
        "id": 278,
        "pregunta": "¿Qué documento no está obligado a portar usted siempre en su vehículo?",
        "opciones": [
    ...
    {
        "id": 279,
        "pregunta": "En relación con las infracciones a las normas del tránsito, ¿cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)?",
        "opciones": [
    ...
    },
    {
        ...
        "opciones": [
            ...
            "Dos infracciones graves cometidas en un período de 12 meses dar origen a una suspensión de la licencia de conducir del infractor.",
